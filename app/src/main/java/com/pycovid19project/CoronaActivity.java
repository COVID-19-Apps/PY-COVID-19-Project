...
import com.pycovid19project.Adapter.CoronaAdapter;
import com.pycovid19project.Adapter.FAQAdapter;
import com.pycovid19project.Models.Corona;
import com.pycovid19project.Models.FAQ;
import com.pycovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Puducherry").getJSONObject("districtData");
